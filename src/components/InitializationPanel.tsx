...
// Schema de validation pour l'administrateur avec mot de passe
...
export default function InitializationPanel({ onComplete }: InitializationPanelProps) {
    ...
    const initializeDatabase = async (data: AdminFormData) => {
        ...
        try {
            // Créer le compte administrateur avec Firebase Auth
            const success = await createAdminAccount(data.email, data.password, data.name);
                        ...
                        <div className="p-8 text-center">
                            ...
                            <div className="space-y-4 max-w-md mx-auto">
                                <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg">
                                    ...
                                    <span className="text-sm text-blue-800">Création du compte administrateur</span>
                                </div>
                                <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg">
                                    <Loader2 className="w-5 h-5 animate-spin text-blue-600" />
